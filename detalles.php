    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarHeader">
        ...
        <a href="carrito.php" class="btn btn-primary">
          Carrito <span id="num_cart" class="badge bg-secundary">5</span>
        </a>
      </div>
    </div>
  </div>
          ...
          <div class="carousel-inner">
           ...
           <?php foreach($imagenes as $img) {?> 
            <div class="carousel-item">
                <img src="<?php echo $img; ?>" style="display: block; width: 500px; height: 500px;"> <!--style="margin-right: 0px !important; overflow: hidden;"-->
            </div> 
           <?php }?>
          </div>
